...
export function protocolError(
	...
	const message =
		error instanceof Error ? error.message : 'Technocore returned an unexpected response';
...
export function asNodeError(
	...
	return new NodeOperationError(ctx.getNode(), error instanceof Error ? error : String(error), {
		itemIndex,
	});
}
